...
def handle_mention_reaction(bot, message_object, author_id, thread_id, thread_type):
    ...
    try:
        reaction_icons = [
            "nguyen hoang gia bao 💎", "Đca nguyen hoang gia bao Bá ❄️", "nguyen hoang gia bao Dzai 💎", "Hoàng Lov Trân💗", "Dạ Đây Ạ🐧",
            "iu Trân💗", "Đca nguyen hoang gia bao⚡", "Dạ e đây😎", "Sao?", "j thk e❓",
            "Hả", "Gì", "Kêu mẹ j", "Ngứa tai v?", "Cút", "Mày rảnh?",
            "nhiều chuyện thế", "thk l", "Đm nguyen hoang gia bao Dzai 💎", "nguyen hoang gia bao dca t ",
...
{color}
╔════════════════════════════════════════════════════════════════════════════════════╗
║   🚀 nguyen hoang gia bao ĐÃ KHỞI ĐỘNG THÀNH CÔNG 💖                                                                                                                                                                  
...
║                                                                                   
╠════════════════════════════════════════════════════════════════════════════════════╣
║                               BẢNG GIÁ THUÊ BOT AKA nguyen hoang gia bao                                   
║   ---------------------------------------------                                    
║   💎 5k 1 Ngày 
║   💎 16k 1 Tuần
║   💎 36k 1 Tháng
        ...
        for link, success, msg, group_info in results:
            try:
                if success:
                    ...
                    icon = random.choice(["🗿Basangcoder😗", "🐢nguyen hoang gia baobárõ🤨", "💸thuêbot50k🐧","💸Nhận Rãi Thuê","🌟Cho Thuê Bót😹"])
                else:
                    icon = "Phải Chịu🐻"
